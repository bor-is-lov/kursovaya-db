...
System::Void ChangeProjects::ClearMessageLabels(System::Object^ sender, System::EventArgs^ e) {
	this->addMessageLabel->Text = " ";
	this->changeMessageLabel->Text = " ";
	this->deleteMessageLabel->Text = " ";
}

System::Void ChangeProjects::tabControl_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
	this->Text = this->tabControl->SelectedTab->Text;
	ClearMessageLabels(sender, e);
}

System::Void ChangeProjects::backButton_Click(System::Object^ sender, System::EventArgs^ e) {
	args->at(0) = "SelectProject";
	this->Close();
}

System::Void ChangeProjects::addButton_Click(System::Object^ sender, System::EventArgs^ e) {
	ClearMessageLabels(sender, e);
	if (this->addTextBox->Text == "")
		return;
	res->reset((*stmt)->executeQuery("SELECT id FROM Projects WHERE BINARY projectName = '" +
	msclr::interop::marshal_as<std::string>(this->addTextBox->Text) + "'"));
	while ((*res)->next()) {
		this->addMessageLabel->ForeColor = System::Drawing::Color::DarkRed;
		this->addMessageLabel->Text = "Ошибка: такой проест уже есть";
		return;
	}
	(*stmt)->execute("INSERT INTO Projects(projectName, userId) VALUES('" +
		msclr::interop::marshal_as<std::string>(this->addTextBox->Text) +
		"', " + args->at(1) + ")");
	this->addTextBox->Text = "";
	this->addMessageLabel->ForeColor = System::Drawing::Color::DarkGreen;
	this->addMessageLabel->Text = "Проект успешно добавлен";
}

System::Void ChangeProjects::changeButton_Click(System::Object^ sender, System::EventArgs^ e) {
	ClearMessageLabels(sender, e);
	...
	while ((*res)->next()) {
		...
		this->changeMessageLabel->Text = "Ошибка: такой проест уже есть";
		return;
	}
	res->reset((*stmt)->executeQuery(
		"SELECT id FROM Projects WHERE BINARY projectName = '" +
		msclr::interop::marshal_as<std::string>(this->oldTextBox->Text) +
		"'"));
	while ((*res)->next()) {
		(*stmt)->execute("UPDATE Projects SET projectName = '" +
			msclr::interop::marshal_as<std::string>(this->newTextBox->Text) +
			"' WHERE BINARY projectName = '" +
			msclr::interop::marshal_as<std::string>(this->oldTextBox->Text) + "'");
		this->oldTextBox->Text = "";
		this->newTextBox->Text = "";
		this->changeMessageLabel->ForeColor = System::Drawing::Color::DarkGreen;
		this->changeMessageLabel->Text = "Проект успешно изменен";
		return;
	}
	this->changeMessageLabel->ForeColor = System::Drawing::Color::DarkRed;
	this->changeMessageLabel->Text = "Ошибка: нет проекта с таким именем";
}

System::Void ChangeProjects::deleteButton_Click(System::Object^ sender, System::EventArgs^ e) {
	ClearMessageLabels(sender, e);
	...
	res->reset((*stmt)->executeQuery(
		...
		"'"));
	while ((*res)->next()) {
		(*stmt)->execute("DELETE FROM Projects WHERE projectName = '" +
			msclr::interop::marshal_as<std::string>(this->deleteTextBox->Text) + "'");
		this->deleteTextBox->Text = "";
		this->deleteMessageLabel->ForeColor = System::Drawing::Color::DarkGreen;
		this->deleteMessageLabel->Text = "Проект успешно удалён";
		return;
	}
	this->deleteMessageLabel->ForeColor = System::Drawing::Color::DarkRed;
	this->deleteMessageLabel->Text = "Ошибка: нет проекта с таким именем";
}

#pragma region Windows Form Designer generated code
void ChangeProjects::InitializeComponent(void) {
    ...
    this->tabControl->SelectedIndexChanged += gcnew System::EventHandler(this, &ChangeProjects::tabControl_SelectedIndexChanged);
    this->tabControl->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // addPage
    // 
    ...
    this->addPage->Text = L"Добавить проект";
    this->addPage->UseVisualStyleBackColor = true;
    this->addPage->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // addMessageLabel
    // 
    ...
    this->addMessageLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // addButton
    // 
    ...
    this->addButton->Click += gcnew System::EventHandler(this, &ChangeProjects::addButton_Click);
    // 
    // addTextBox
    // 
    ...
    this->addTextBox->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // addLabel
    // 
    this->addLabel->AutoSize = true;
    this->addLabel->Font = (gcnew System::Drawing::Font(L"Bahnschrift SemiCondensed", 15));
    this->addLabel->Location = System::Drawing::Point(104, 4);
    this->addLabel->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->addLabel->Name = L"addLabel";
    this->addLabel->Size = System::Drawing::Size(170, 24);
    this->addLabel->TabIndex = 7;
    this->addLabel->Text = L"Имя нового проекта:";
    this->addLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // changePage
    // 
    ...
    this->changePage->Text = L"Изменить проект";
    this->changePage->UseVisualStyleBackColor = true;
    this->changePage->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // changeMessageLabel
    // 
    ...
    this->changeMessageLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // newTextBox
    // 
    ...
    this->newTextBox->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // newLabel
    // 
    this->newLabel->AutoSize = true;
    this->newLabel->Font = (gcnew System::Drawing::Font(L"Bahnschrift SemiCondensed", 15));
    this->newLabel->Location = System::Drawing::Point(107, 65);
    this->newLabel->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->newLabel->Name = L"newLabel";
    this->newLabel->Size = System::Drawing::Size(164, 24);
    this->newLabel->TabIndex = 16;
    this->newLabel->Text = L"Новое имя проекта:";
    this->newLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // changeButton
    // 
    ...
    this->changeButton->Click += gcnew System::EventHandler(this, &ChangeProjects::changeButton_Click);
    // 
    // oldTextBox
    // 
    ...
    this->oldTextBox->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // oldLabel
    // 
    this->oldLabel->AutoSize = true;
    this->oldLabel->Font = (gcnew System::Drawing::Font(L"Bahnschrift SemiCondensed", 15));
    this->oldLabel->Location = System::Drawing::Point(104, 4);
    this->oldLabel->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->oldLabel->Name = L"oldLabel";
    this->oldLabel->Size = System::Drawing::Size(171, 24);
    this->oldLabel->TabIndex = 13;
    this->oldLabel->Text = L"Старое имя проекта:";
    this->oldLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // deletePage
    // 
    ...
    this->deletePage->Text = L"Удалить проект";
    this->deletePage->UseVisualStyleBackColor = true;
    this->deletePage->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // deleteMessageLabel
    // 
    ...
    this->deleteMessageLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // deleteButton
    // 
    ...
    this->deleteButton->Click += gcnew System::EventHandler(this, &ChangeProjects::deleteButton_Click);
    // 
    // deleteTextBox
    // 
    ...
    this->deleteTextBox->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // deleteLabel
    // 
    this->deleteLabel->AutoSize = true;
    this->deleteLabel->Font = (gcnew System::Drawing::Font(L"Bahnschrift SemiCondensed", 15));
    this->deleteLabel->Location = System::Drawing::Point(84, 4);
    this->deleteLabel->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->deleteLabel->Name = L"deleteLabel";
    this->deleteLabel->Size = System::Drawing::Size(210, 24);
    this->deleteLabel->TabIndex = 19;
    this->deleteLabel->Text = L"Имя удаляемого проекта:";
    this->deleteLabel->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
    // 
    // backButton
    // 
    ...
    this->backButton->Location = System::Drawing::Point(314, 262);
    ...
    this->backButton->Click += gcnew System::EventHandler(this, &ChangeProjects::backButton_Click);
    // 
    // ChangeProjects
    // 
    ...
    this->Name = L"ChangeProjects";
    this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
    this->Text = L"Добавить проект";
    this->Click += gcnew System::EventHandler(this, &ChangeProjects::ClearMessageLabels);
